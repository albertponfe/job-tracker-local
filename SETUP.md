...
- Row buttons let you **edit**, **archive**, or **remove** an application. Removing asks
...
2. In the app, click **AI** and choose **Ollama**.
...
3. In the app, click **Import**, paste the link, then click **Preview & map columns**.
...
Everything is in the **`data/`** folder. Copy that whole folder for a restorable backup,
or click **Import** to export application rows as CSV or JSON.
